        ...
        <div className="fixed bottom-0 flex flex-col w-screen h-screen items-center justify-center">
            ...
            {stepRegister === 0 &&
                <div className="flex flex-col bg-green-900  w-11/12 md:w-7/12 lg:w-4/12 h-[60vh] pt-10 absolute bottom-0 items-center pb-28 rounded-t-xl shadow-2xl">
                    ...
                    <p className="text-xl py-4 font-bold text-white">Bem-vindo ao <strong>SENINHA LOTT</strong></p>
                    ...
                    <div className="w-full px-10">
                        {loadingLogin ?
                            <div disabled className="flex flex-row items-center justify-center h-10 bg-green-800 w-full rounded uppercase text-white">
                ...
                <div className="flex flex-col bg-green-900 w-11/12 md:w-7/12 lg:w-4/12 h-[60vh] pt-10 absolute bottom-0 items-center pb-28 rounded-t-xl shadow-2xl">
                    ...
                    <div className="w-full p-10">
                        {loadingLogin ?
                            ...
                            :
                            <ButtonComp onClick={() => onOTPVerify()} disabled={phone.length < 13 ? true : false}>
                                Entrar
                            </ButtonComp>
                        }
                    </div>
                    ...
                    <form className="flex p-10 flex-col items-center justify-center text-center w-full space-y-6">
                        ...
                        <div className="w-full">
                            {loadingLogin ?
                                ...
                                :
                                <ButtonComp onClick={() => lastStepRegister()} disabled={phone.length < 13 ? true : false}>
                                    cadastrar
                                </ButtonComp>
                            }
                        </div>
